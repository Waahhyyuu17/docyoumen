...
<header class="site-header">
  <div class="header-inner">
    ...
    <nav class="header-nav">
      ...
      <a href="https://portofolio-wahyu.page.gd/" target="_blank" rel="noopener noreferrer" class="nav-link">Tentang Saya</a>
    </nav>
  </div>
</header>
...
<section class="kontak-section" id="kontak">
  <div class="kontak-header">
    <span class="kontak-badge">Kontak</span>
    <h2 class="kontak-title">Ada sistem yang ingin dibangun?</h2>
    <p class="kontak-subtitle">Terbuka untuk diskusi seputar pengembangan sistem internal, kerja sama proyek Worktiva, atau perbaikan hardware/printer lepas.</p>
  </div>

  <div class="kontak-stats">
    <div class="kontak-stat">
      <div class="kontak-stat-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
      </div>
      <span class="kontak-stat-label">Email</span>
      <span class="kontak-stat-value">wahyuardiansyah1701@gmail.com</span>
    </div>
    <div class="kontak-stat">
      <div class="kontak-stat-icon">
      ...
      <span class="kontak-stat-label">WhatsApp</span>
      <span class="kontak-stat-value">+62 896-7665-8564</span>
    </div>
    <div class="kontak-stat">
      <div class="kontak-stat-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
      </div>
      <span class="kontak-stat-label">Lokasi</span>
      <span class="kontak-stat-value">Kota Bekasi, Jawa Barat</span>
    </div>
    <div class="kontak-stat">
      <div class="kontak-stat-icon">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
      </div>
      <span class="kontak-stat-label">Respon</span>
      <span class="kontak-stat-value">&lt; 24 jam</span>
    </div>
  </div>

  <div class="kontak-card">
    <div class="kontak-card-info">
      <h3>Mari diskusikan kebutuhan IT Anda.</h3>
      <a href="https://portofolio-wahyu.page.gd/" target="_blank" rel="noopener noreferrer" class="kontak-about-link">Tentang Saya &rarr;</a>
      <p>Bisa lewat form di samping, atau langsung lewat kontak berikut:</p>
      <div class="kontak-list">
        <a href="mailto:wahyuardiansyah1701@gmail.com" class="kontak-list-item">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
          <span>wahyuardiansyah1701@gmail.com</span>
        </a>
        <a href="https://wa.me/6289676658564" target="_blank" rel="noopener noreferrer" class="kontak-list-item">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.32 4.95L2 22l5.25-1.38a9.9 9.9 0 0 0 4.79 1.22h.01c5.46 0 9.91-4.45 9.91-9.91C21.96 6.45 17.51 2 12.04 2zm0 18.1a8.2 8.2 0 0 1-4.19-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.18 8.18 0 1 1 6.98 3.86zm4.48-6.13c-.25-.12-1.45-.72-1.68-.8-.22-.08-.39-.12-.55.12-.16.25-.63.8-.78.96-.14.16-.29.18-.54.06-.25-.12-1.04-.38-1.99-1.22-.73-.65-1.23-1.46-1.37-1.71-.14-.25-.02-.38.11-.5.11-.11.25-.29.37-.43.12-.15.16-.25.25-.42.08-.16.04-.31-.02-.43-.06-.12-.55-1.32-.75-1.81-.2-.48-.4-.41-.55-.42h-.47c-.16 0-.43.06-.65.31-.22.25-.86.84-.86 2.04 0 1.2.88 2.36 1 2.52.12.16 1.73 2.64 4.2 3.7.59.25 1.05.4 1.41.52.59.19 1.13.16 1.56.1.48-.07 1.45-.59 1.65-1.16.2-.57.2-1.06.14-1.16-.06-.1-.22-.16-.47-.28z"/></svg>
          <span>+62 896-7665-8564</span>
        </a>
        <a href="https://github.com/Waahhyyuu17" target="_blank" rel="noopener noreferrer" class="kontak-list-item">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 19c-4.3 1.4-4.3-2.5-6-3m12 5v-3.5c0-1 .1-1.4-.5-2 2.8-.3 5.5-1.4 5.5-6a4.6 4.6 0 0 0-1.3-3.2 4.2 4.2 0 0 0-.1-3.2s-1.1-.3-3.5 1.3a12.3 12.3 0 0 0-6.2 0C6.5 2.8 5.4 3.1 5.4 3.1a4.2 4.2 0 0 0-.1 3.2A4.6 4.6 0 0 0 4 9.5c0 4.6 2.7 5.7 5.5 6-.6.6-.6 1.2-.5 2V21"/></svg>
          <span>github.com/Waahhyyuu17</span>
        </a>
        <a href="https://linkedin.com/in/wahyu-ardiansyah-0622a226a" target="_blank" rel="noopener noreferrer" class="kontak-list-item">
        ...
        <a href="https://instagram.com/waahhyyuu17" target="_blank" rel="noopener noreferrer" class="kontak-list-item">
          ...
          <span>instagram.com/waahhyyuu17</span>
        </a>
      </div>
    </div>
    <form class="kontak-form" id="kontakForm" autocomplete="off">
      <div class="kontak-field">
        <label for="kontakNama">Nama</label>
        <input type="text" id="kontakNama" name="nama" placeholder="Nama Anda" required>
      </div>
      <div class="kontak-field">
        <label for="kontakEmail">Email</label>
        <input type="email" id="kontakEmail" name="email" placeholder="email@anda.com" required>
      </div>
      <div class="kontak-field">
        <label for="kontakPesan">Pesan</label>
        <textarea id="kontakPesan" name="pesan" rows="4" placeholder="Ceritakan kebutuhan Anda..." required></textarea>
      </div>
      <input type="text" name="website" class="kontak-honeypot" tabindex="-1" autocomplete="off">
      <button type="submit" class="kontak-submit" id="kontakSubmitBtn">Kirim Pesan</button>
    </form>
  </div>
</section>
